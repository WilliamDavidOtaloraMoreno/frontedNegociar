...
<div className="container">
  <div className="grids-forms">
      <div className="main-midd">
          <h4 className="title-head">Boletín informativo: Obtenga actualizaciones y últimas noticias</h4>
          
      </div>
      <div className="main-midd-2">
          <form action="#" method="post" className="rightside-form">
              <input type="email" name="email" placeholder="Ingresa tu correo"/>
              <button className="btn" type="submit">Suscribirse</button>
          </form>
      </div>
    </div>
  </div>
      ...
      <div className="container pt-5">
          ...
          <div className="d-grid grid-col-4 footer-top-29">
              ...
              <div className="footer-list-29 footer-3">
                  <div className="properties">
                      ...
                      <a href="#"><img src="assets/images/g7.jpg" className="img-responsive" alt=""/><p>We Are Leading International Consultiing Agency</p></a>
                      ...
                      <a href="#"><img src="assets/images/g9.jpg" className="img-responsive" alt=""/><p>Doloremque velit sapien labore eius itna</p></a>
                  </div>
              </div>
          ...
          <div className="bottom-copies text-center">
              <p className="copy-footer-29">© 2020 Estate Agent. All rights reserved | Designed by <a href="https://w3layouts.com">W3layouts</a></p>
