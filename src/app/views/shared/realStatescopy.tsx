            ...
            <div className="features-with-17-top_sur">
              <div className="row">
                    ...
                    <div className="card-footer">
                      ...
                      <div className="stats">
                        <p className="card-category">
                          <i className="material-icons">place</i> Barcelona,
                          Spain
                        </p>
                      </div>
                    </div>
                ...
                <div>
                  <h1>Properties</h1>
                  <ul>
                    {Array.isArray(properties) && properties.map((property, contador) => (
            ...
            <div className="row w3-services-grids py-lg-5">
              <div className="col-lg-7 w3-services-right-grid mt-lg-0">
                ...
                <p className="mt-3">
                  ...
                  eiusmod tempor incididunt ut labore et dolore magna aliqua. On
            ...
            <div className="row mt-5 pt-3">
              <div className="col-lg-4 col-md-6">
                <div className="card">
                  ...
                  <div className="icon-holder">
                    <span
                      className="fa fa-certificate service-icon"
                      aria-hidden="true"
                    ></span>
                  </div>
                  <div className="open-description">
                    <p>
                      ...
                      Id, minima. It is a long established fact that a reader
              ...
              <div className="col-lg-4 col-md-6 mt-md-0 mt-5 pt-md-0 pt-3">
                <div className="card">
                  ...
                  <div className="icon-holder">
                    <span
                      className="fa fa-user service-icon"
                      aria-hidden="true"
                    ></span>
                  </div>
                  <div className="open-description">
              ...
              <div className="col-lg-4 col-md-6 mt-lg-0 mt-5 pt-lg-0 pt-3">
                <div className="card">
                  ...
                  <div className="icon-holder">
                    <span
                      className="fa fa-home service-icon"
                      aria-hidden="true"
                    ></span>
                  </div>
                  <div className="open-description">
