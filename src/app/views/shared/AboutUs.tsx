        ...
        <div className="container py-md-3">
            <div className="cwp4-two row">
                ...
                <div className="cwp4-text col-lg-6">
                    ...
                    <a className="btn btn-secondary btn-theme3 mt-3" href="#team"> Acerca de nuestro equipo</a>
                </div>
...
<div className="w3-services-ab py-5">
    <div className="container py-lg-3">
        ...
        <div className="row w3-services-grids py-lg-5">
            <div className="col-lg-3 w3-services-left-grid">
             
            </div>
            <div className="col-lg-9 w3-services-right-grid pl-lg-5">
                <h4>Somos Socios Inmobiliarios con Experiencia</h4>
                <p className="mt-3">Lorem ipsum dolor sit amet, consectetur adipisicingelit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
                    ...
                    <div className="col-sm-6">
                     ...
                     <div className="col-sm-6 mt-sm-0 mt-5">	
                        <div className="float-mid feature-gd">	
                          <div className="icon"> <span className="fa fa-trophy" aria-hidden="true"></span></div>
                          <div className="icon-info">
	...
	<div className="team-content" id="team">
		<div className="container">
			...
			<div className="d-grid grid-col-4 text-center mt-5 pt-3">
				...
				<div className="team-main-6">
					<div className="column-6">
						<a href="#"><img className="img-responsive" src={t2} alt=" "/></a>
						<div className="buttons-teams">
							<a href="#facebook" className="facebook"><span className="fa fa-facebook"></span></a>
							<a href="#twitter" className="twitter mr-2 ml-2"><span className="fa fa-twitter"></span></a>
							<a href="#instagram" className="instagram"><span className="fa fa-instagram"></span></a>
					...
					<div className="right-team-9">
						...
						<h6><a href="#" className="title-team-32">John doe</a></h6>
				...
				<div className="team-main-6">
					<div className="column-6">
						<a href="#"><img className="img-responsive" src={t3} alt=" "/></a>
						<div className="buttons-teams">
							<a href="#facebook" className="facebook"><span className="fa fa-facebook"></span></a>
							<a href="#twitter" className="twitter mr-2 ml-2"><span className="fa fa-twitter"></span></a>
							<a href="#instagram" className="instagram"><span className="fa fa-instagram"></span></a>
					...
					<div className="right-team-9">
						...
						<h6><a href="#" className="title-team-32">Dane Walker</a></h6>
				...
				<div className="team-main-6">
					<div className="column-6">
						<a href="#"><img className="img-responsive" src={t4}alt=" "/></a>
						<div className="buttons-teams">
							<a href="#facebook" className="facebook"><span className="fa fa-facebook"></span></a>
							<a href="#twitter" className="twitter mr-2 ml-2"><span className="fa fa-twitter"></span></a>
							<a href="#instagram" className="instagram"><span className="fa fa-instagram"></span></a>
					...
					<div className="right-team-9">
						...
						<h6><a href="#" className="title-team-32">Elijah</a></h6>
